function sliderTab() {
    ...
    let dots = [];
    const slider = document.querySelector('.check_pr_2_0_0__box');
    const slideItems = document.querySelectorAll('.check_pr_2_0_0__item');
    let currentSlide = 0;
    ...
    function createDots() {
        ...
        dotsContainer.classList.add('check_pr_2_0_0__dots');
        ...
        for (let i = 0; i < totalDots; i++) {
            ...
            dot.classList.add('check_pr_2_0_0__dot');
    ...
    buttonContainer.classList.add('check_pr_2_0_0__controls');

    // Tạo button prev
    const prevButton = document.createElement('button');
    prevButton.textContent = '❮';
    prevButton.addEventListener('click', prevSlide);
    prevButton.classList.add('check_pr_2_0_0__prev');

    // Tạo button next
    const nextButton = document.createElement('button');
    nextButton.textContent = '❯';
    nextButton.addEventListener('click', nextSlide);
    nextButton.classList.add('check_pr_2_0_0__next');
    ...
    controlsContainer.classList.add('check_pr_2_0_0__controlsContainer');
